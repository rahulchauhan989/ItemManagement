...
public static class AppMessages
{
    ...
    public const string AlreadyInSameStatus= "Request is already in the same status.";
    ...
    public const string ItemTypeAlreadyDeleted = "ItemType is already deleted.";
    ...
    public const string PurchaseRequestDetailsCannotBeEmpty = "Purchase Request items cannot be empty.";
    ...
    public const string duplicateItemModelIds = "Duplicate ItemModelId entries are not allowed.";
    ...
    public const string ItemItemRequestDetailsRetrieved = "Item request items retrieved successfully.";
    public const string NullItemTypeRequest = "ItemType request cannot be null.";
    public const string ItemItemRequestDetailsCannotBeEmpty = "Item request items cannot be empty.";
    ...
    public const string OnlyPendingReqEditable = "Only Pending and Draft requests can be edited.";
    ...
    public const string CancelRequest = "Only the creator can cancel the request.";
